...
/// Confetti view controller
class ConfettiView: UIViewController {
    ...
    lazy var confettiCells: [CAEmitterCell] = {
        return confettiTypes.map { confettiType in
            ...
            cell.spin = 5
            cell.spinRange = 8
            cell.yAcceleration = AppConfig.confettiSpeed
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + AppConfig.confettiDuration) {
